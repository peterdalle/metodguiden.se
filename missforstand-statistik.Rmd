...
Låt oss ta ett exempel. En opinionsundersökning säger att 25 % av svenskarna sympatiserar med Socialdemokraterna, med ett 95 % konfidensintervall på 23–27 (%-enheter).
...
Konfidensintervall har sitt ursprung i frekventistisk statistik, vilket är en filosofisk inriktning inom sannolikhetsteori och innebär att man räknar hur många gånger någonting förekommer (frekvenser) och drar slutsatser om sannolikheter utifrån *alla* frekvenser över tid. Det går alltså inte tillskriva en sannolikhet till ett specifikt värde över huvud taget.^[Ironiskt nog kan man vara 100 % säker på att konfidensintervallet kommer att innehålla rätt värde 95 % av gångerna. Den första procenten "100 %" syftar nämligen på individens kunskapsteoretiska övertygelse, medan den andra procenten "95 %" syftar på hur många gånger det sker. Det speglar med andra ord de olika filosofiska sannolikhetsteorierna, nämligen bayesianism och frekventism.]
...
> Över tid kommer 95 % av värdena att ligga inom intervallet 23 till 25 (%-enheter).

Det innebär:

- Om man gör om samplingen 100 gånger, så kommer (i genomsnitt) 95 värden att ligga inom intervallet 23 till 27 (%-enheter). De övriga värdena kommer att ligga utanför intervallet.^[Väljer man ett konfidensintervall på 99 % så kommer 99 av 100 värden att ligga inom intervallet. De övriga värdena kommer därmed ligga utanför intervallet. Ju högre konfidensnivå, såsom 99 %, desto längre ifrån varandra blir också övre och undre gränsen för konfidensintervallet.]
- Med andra ord så så finns ett enskilt värde inom intervallet, eller så är det utanför. Det är antingen eller.
- Det finns ingen sannolikhet kopplad till ett enskilt värde över huvud taget, utan sannolikheten räknas ut genom att titta på andelen av samtliga värden *över tid*.

Eftersom man normalt sett endast gör en (1) undersökning så får man ju fram ett enskilt värde tillsammans med ett konfidensintervall. Men konfidensintervall handlar ju om samplingar över tid! Så man har med andra ord ingen som helst aning om värdet 25 % i praktiken ligger innanför eller utanför konfidensintervallet 23 till 25 (%-enheter). Det kan man bara veta om man gör upprepade mätningar. Och upprepade mätningar på människor är svårt med tanke på att de också kan förändra sina partisympatier. Med andra ord, även om teorin bakom konfidensintervall skulle vara fullständigt felfri, så beror resultaten i en opinionsundersökning också på hur frågor formuleras, i vilket sammanhang de frågas med mera.
...
## Missförstånd: "Om resultatet inte är statistiskt signifikant, hittades ingen skillnad (eller samband)"

Det är delvis felaktigt eftersom man själv kan välja när resultatet ska vara signifikant, se missförståndet ovan. Traditionellt sett har signifikansnivån satts på 5 % (det vill säga när p < 0,05). Men denna gräns är fullständigt godtycklig.

Däremot måste man sätta gränsen *före* man gör analysen. Det är ingen idé att sätta gränsen efter man har analyserat datan, för då kan man få vad som helst att vara signifikant. I vissa artiklar kan man läsa att resultatet ibland är p < 0,05 för att i nästa stycke se att ett annat resultat är p < 0,01. Men i stället för att blanda signifikansnivåer bör man skriva ut det fullständiga p-värdet.
