...
- Mäns lön är `r as.integer(men_salary)` kronor
- Kvinnors lön är `r as.integer(female_salary)` kronor

Kvinnor tjänar nästan hälften av vad männen tjänar. Hur kan det komma sig? Svaret är att fler kvinnor jobbar deltid och i offentlig sektor, och där finns de låtbetalda jobben.

Men gör vi fler analyser stöter vi också på andra slutsatser som kan verka paradoxala. Titta vad högutbildade respektive lågutbildade tjänar:

- Högutbildades lön är `r as.integer(high_edu_salary)` kronor
- Lågutbildades lön är `r as.integer(low_edu_salary)` kronor

Här ser vi att de med låg utbildning tjänar mer än de med hög utbildning. Betyder det att utbildning inte lönar sig? Det är fel slutsats att dra, eftersom vi redan vet att vi gav högutbildade 5 000 kronor mer i lön.

I vår fiktiva arbetsmarknad med tio personer har vi fyra variabler (kön, utbildning, sektor och arbetstid) som logiskt sett har möjlighet att påverka lönen. Om man bara väljer ut en variabel (till exempel kön) och sedan jämför medelvärdena och hittar en skillnad mellan kvinnor och män, kan man alltså förledas att tro att skillnaden måste bero på den variabel man har valt. Det är det som menas med den *univariata* fallasin ("univariat" betyder *en*---i motsats till flera).
