# Datavisualisering {#dataviz}

Här hittar du:

- Råd för att skapa bättre diagram
- Program för att göra diagram och grafik
- Vilket diagram du ska välja beroende på hur din data är strukturerad
...
- [Checklista för statistika undersökningar](#checklist-stats) - kritiska frågor för att bedöma någons tabeller eller diagram.
